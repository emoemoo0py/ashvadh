...
function namespacesSdkFactory() {
  return {
    ...
    'ecom.v2': (context: WixCodeApiFactoryArgs) =>
      wixEcomV2Loader(context),

    'data-collections': (context: WixCodeApiFactoryArgs) =>
      wixDataCollectionsLoader(context),

    'data.v2': (context: WixCodeApiFactoryArgs) =>
      wixDataV2Loader(context),
    ...
    'crm.v2': (context: WixCodeApiFactoryArgs) =>
      wixCrmV2Loader(context),

    'notifications.v2': (context: WixCodeApiFactoryArgs) =>
      wixNotificationsV2Loader(context),

    'stores-v3': (context: WixCodeApiFactoryArgs) =>
      wixStoresV3Loader(context),
    ...
    'riseevent': (context: WixCodeApiFactoryArgs) =>
      wixRiseeventLoader(context),
    ...
    'rise.v2': (context: WixCodeApiFactoryArgs) =>
      wixRiseV2Loader(context),
    ...
    'search.v2': (context: WixCodeApiFactoryArgs) =>
      wixSearchV2Loader(context),

    'members-about.v1': (context: WixCodeApiFactoryArgs) =>
      wixMembersAboutV1Loader(context),

    'forms.v2': (context: WixCodeApiFactoryArgs) =>
      wixFormsV2Loader(context),
  };
}
...
const wixMembersAboutV1Loader = (context: WixCodeApiFactoryArgs): Promise<any> =>
  import(
...
const wixLivevideoBackendLoader = (context: WixCodeApiFactoryArgs): Promise<any> =>
  import(
...
const wixMembersFollowersBackendV1Loader = (context: WixCodeApiFactoryArgs): Promise<any> =>
  import(
...
const wixNotificationsV3Loader = (context: WixCodeApiFactoryArgs): Promise<any> =>
  import(
...
const wixTableReservationsV2Loader = (context: WixCodeApiFactoryArgs): Promise<any> =>
  import(
...
const wixSecretsBackendV2Loader = (context: WixCodeApiFactoryArgs): Promise<any> =>
  import(
...
const wixNotificationsV2Loader = (context: WixCodeApiFactoryArgs): Promise<any> =>
  import(
...
const wixStoresBackendV3Loader = (context: WixCodeApiFactoryArgs): Promise<any> =>
  import(
...
const wixSenderEmailsBackendLoader = (context: WixCodeApiFactoryArgs): Promise<any> =>
  import(
...
const wixDataCollectionsLoader = (context: WixCodeApiFactoryArgs): Promise<any> =>
  import(
...
const wixDataExternalDatabaseConnectionsLoader = (context: WixCodeApiFactoryArgs): Promise<any> =>
  import(
...
const wixDataResourceusageServiceV1Loader = (context: WixCodeApiFactoryArgs): Promise<any> =>
  import(
...
const wixAuthManagementV2Loader = (context: WixCodeApiFactoryArgs): Promise<any> =>
  import(
...
const wixEntitlementsBackendLoader = (
  context: WixCodeApiFactoryArgs,
): Promise<any> =>
  import(
...
const wixContactsBackendV2Loader = (
  context: WixCodeApiFactoryArgs,
): Promise<any> =>
  import(
...
const wixStoresBackendPocV2Loader = (
  context: WixCodeApiFactoryArgs,
): Promise<any> =>
  import(
...
const wixBookingsBackendV2Loader = (
  context: WixCodeApiFactoryArgs,
): Promise<any> =>
  import(
